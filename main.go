...
Options:
	...
	--kill_switch                Block all traffic if the VPN connection drops. Requires --default_route. WARNING: on graceful exit the block remains until you reboot or manually remove routes.
